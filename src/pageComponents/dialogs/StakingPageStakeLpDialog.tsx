        ...
        >
          ...
          <Row className="justify-between items-center mb-6">
            <div className="text-xl font-semibold text-white">
              {stakeDialogMode === 'withdraw' ? 'Unstake MAKI' : 'Stake MAKI'}
            </div>
            ...
            <Button
              ...
              validators={[
                ...
                { should: gt(userInputTokenAmount, 0) },
                {
                  ...
                  fallbackProps: { children: 'Insufficient MAKI Balance' }
                },
                {
                  should: stakeDialogMode === 'withdraw' ? true : userHasLp,
                  fallbackProps: { children: stakeDialogMode === 'withdraw' ? 'No Unstakable MAKI' : 'No Stakable MAKI' }
                }
              ]}
              onClick={() => {
