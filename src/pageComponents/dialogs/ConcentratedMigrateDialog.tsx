  ...
  const step1 = (closeDialog: () => void) => (
    <Col className="items-center">
      ...
      <div className="mb-6 text-center">
        ...
        <Link href="https://makiso.gitbook.io/maki/concentrated-liquidity/what-is-concentrated-liquidity">
          {alertLinkText}
        </Link>
      </div>
      ...
      <div className="relative mb-5">
        ...
        <div className="text-[#abc4ff] text-sm">
          ...
          <Link
            ...
            // href="https://makiso.gitbook.io/maki/liquidity-providers/providing-concentrated-liquidity-clmm"
