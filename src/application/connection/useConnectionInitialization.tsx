...
import { ACTIVE_NETWORK } from '@raydium-io/raydium-sdk'
import { NETWORK } from '@raydium-io/raydium-sdk'
  ...
  ACTIVE_NETWORK == NETWORK.MAINNET
    ? {
        rpcs: [
          {
            name: 'mainnet',
            url: 'https://ultra-quick-frost.solana-mainnet.quiknode.pro/37bcbcb0976ff9f271aaf13e3bee2452de366636/',
            net: 'mainnet'
          }
        ],
    ...
    : {
        rpcs: [{ name: 'devnet', url: 'https://api.devnet.solana.com/', net: 'devnet' }],
        devrpcs: [
          {
            name: 'mainnet',
            url: 'https://ultra-quick-frost.solana-mainnet.quiknode.pro/37bcbcb0976ff9f271aaf13e3bee2452de366636/',
