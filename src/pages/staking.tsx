...
export default function StakingPage() {
  return (
    <PageLayout mobileBarTitle="Staking" metaTitle="Staking - MakiDEX" contentButtonPaddingShorter>
      <StakingHeader />
      <StakingCard />
      ...
      <Collapse.Body>
        <Row type="grid-x" className="py-4 px-5 relative items-stretch gap-2 grid-cols-[1fr,1fr,1fr,auto]">
          ...
          <TextInfoItem
            ...
            subValue={
              isHydratedFarmInfo(info)
                ? info.stakedLpAmount && `${formatNumber(toString(info.stakedLpAmount, { decimalLength: 0 }))} MAKI`
                : undefined
            }
          />
          <div></div>
