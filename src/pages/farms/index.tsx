...
export default function FarmsPage() {
  ...
  useEffect(() => {
    useFarms.setState({ currentTab: query.tab as 'MakiDEX' | 'Fusion' | 'Ecosystem' | 'Staked' })
  }, [query])
...
function FarmCard() {
  ...
  const farmCardTitleInfo =
    currentTab === 'Ecosystem'
      ...
      : { title: 'MakiDEX Farms', description: 'Stake LP tokens and earn token rewards' }
