...
export default function AcceleRaytor() {
  ...
  return (
    <PageLayout mobileBarTitle="AcceleRaytor" metaTitle="AcceleRaytor - MakiDEX">
  ...
  return (
    <Row className={`AlertText items-center bg-[#abc4ff1a] p-3 rounded-xl mb-6`}>
      ...
      <div className="text-[#ABC4FF80] font-medium text-xs">
        To be eligible for the lottery, you need to <span className="text-[#ABC4FF]">stake 100 MAKI</span> with a
      ...
      >
        <IdoItem
          fieldValue={
            <Row className="items-baseline gap-1">
              <div className="text-white font-medium">
                {toString(stakingHydratedInfo?.userStakedLpAmount) || '--'} MAKI
              </div>
            </Row>
          }
          fieldName={
