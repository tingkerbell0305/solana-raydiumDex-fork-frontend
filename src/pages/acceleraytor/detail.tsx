    ...
    >
      ...
      <div className={`${isMobile ? '' : 'w-0 grow'} m-4`}>
        ...
        >
            ...
            >
              <IdoInfoItem
                ...
                fieldValue={
                  <Row className="items-baseline gap-1">
                    <div className="text-white font-medium">
                      {formatNumber(toString(stakingHydratedInfo?.userStakedLpAmount)) || '--'} MAKI
                    </div>
                  </Row>
                }
                fieldName={
                    ...
                    <Tooltip placement="bottom">
                      ...
                      <Tooltip.Panel>
                        <div className="text-sm font-semibold max-w-[160px]">
                          ...
                          <div className="font-normal text-xs opacity-50">
                            The more and longer you stake MAKI the more tickets you will receive.
                          </div>
                        </div>
                      </Tooltip.Panel>
                    </Tooltip>
          ...
          {idoInfo.isUpcoming && (
            <IdoInfoItem
              fieldName="MAKI staking deadline"
              fieldValue={
                <Row className="items-baseline gap-1">
        ...
        <Row className="overflow-auto gap-6 grow w-0">
          ...
          >
            <Col className="items-center gap-3">
              <StepBadge n={1} />
              <div className="text-sm text-center text-[#ABC4FF] font-semibold">Stake MAKI</div>
            </Col>

            <Col className="grow gap-3">
              <div className="text-xs text-center text-[#ABC4FF] opacity-50">
                Stake and Earn MAKI to participate in pools. The more and longer you stake the more lottery tickets
