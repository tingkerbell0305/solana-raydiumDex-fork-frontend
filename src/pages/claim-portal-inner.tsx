...
export default function CompensationPage() {
  ...
  return (
    <PageLayout mobileBarTitle="Claim portal" metaTitle="Claim portal - MakiDEX" contentButtonPaddingShorter>
        ...
        <div>
          ...
          <div className="text-[#abc4ff] mobile:text-xs mb-4 space-y-4">
            ...
            <div>
              ...
              {/* <Link href="https://makiso.gitbook.io/maki/updates/claim-portal">click here</Link>. */}
              <Link href="https://makiso.gitbook.io/maki/">click here</Link>.
            </div>
          </div>
        </div>
                ...
                {listContent(
                  idx === 0
                    ...
                    : {
                        ...
                        amount4: tokenInfo.debtAmount,
                        tooltip4:
                          'This is the claimable amount of MAKI as compensation and is equal to (Total value in MAKI)*(1.2). This equates to 20% additional MAKI as compensation.'
                      }
                )}
              </Card>
            )
