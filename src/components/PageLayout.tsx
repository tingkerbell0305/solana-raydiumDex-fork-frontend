      ...
      <FadeIn>
        {userHasTargetPosition && (
          <div className="bg-[#dacc363f] text-center text-[#D8CB39] text-sm mobile:text-xs px-4 py-1">
            ...
            <br /> MAKI rewards have shifted from old pools to upgraded pools. Go to the Concentrated liquidity page and
            manually migrate liquidity to continue receiving MAKI rewards.
          </div>
        )}
      </FadeIn>
    </div>
...
function Navbar({
  ...
  const pcNavContent = (
    <Row className="justify-between items-center mobile:h-14 mobile:bg-cyberpunk-card-bg">
      <Link href="/">
        <Image
          className={`cursor-pointer ${inDev ? 'hue-rotate-60' : ''} mobile:hidden w-1/2`}
          src="/logo/dex_logo.png"
        />
      </Link>
      ...
      >
        {isMobile && (
          <Row className="items-center justify-between p-6 mobile:p-4 mobile:pl-8">
            <Link href="/">
              <Image src="/logo/dex_logo.png" className={`mobile:scale-75 ${inDev ? 'hue-rotate-60' : ''}`} />
            </Link>
            <Icon
              size={isMobile ? 'sm' : 'md'}
              heroIconName="x"
        ...
        <Col className="grid grid-rows-[2fr,1fr,auto] flex-1 overflow-hidden">
          <div className="shrink overflow-y-auto min-h-[120px] py-4 space-y-1 mobile:py-0 px-2 mr-2 mobile:ml-2 mb-2">
            ...
            {/* H2W : disable Concentrated Pools */}
            {/* <LinkItem
          ...
          <Col className="overflow-scroll no-native-scrollbar">
            ...
            <div className="flex-1 overflow-auto no-native-scrollbar mt-2">
              ...
              <OptionItem noArrow href="https://makiso.gitbook.io/maki/" iconSrc="/icons/msic-docs.svg">
                Docs
              </OptionItem>
              ...
              {/* <OptionItem noArrow href="" iconSrc="/icons/misc-feedback.svg">
                Feedback
              </OptionItem> */}
            </div>
          </Col>
      ...
      <Row className="items-center">
        ...
        <Row
          className={`grow items-center justify-between text-[#ACE3E5] ${
            isCurrentRoutePath ? 'text-[rgb(255,255,255)]' : ''
